...
contractInst.methods.transfer(accountnode3, amount/4)
  .send({
    from: accountnode2,
    privateFor: [nodePublicKey1, nodePublicKey2, nodePublicKey3],
  })
  .then(res => {
    console.log(res)
  })
...
contractInst.methods.transfer(accountnode4, amount/4)
.send({
  from: accountnode2,
  privateFor: [nodePublicKey1, nodePublicKey2, nodePublicKey3],
})
