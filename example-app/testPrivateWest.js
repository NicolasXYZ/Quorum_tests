...
const eastJson = require('../contract/build/contracts/West.json')
const publicJson = require('../contract/build/contracts/Public.json')

const NODE1 = "http://localhost:22001"


 var nodePublicKey = 'BULeR8JyUWhiuuCMU/HLA0Q5pzkYT+cHII3ZKBey3Bo='
//var nodePublicKey = 'QfeDAys9MPDs2XHExtc84jKGHxZg/aj52DTh0vtA3Xc='
...
var amount = 1000000
let transaction = contractInst.methods.approve(admin2, amount)
