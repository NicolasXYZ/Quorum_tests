...
const config = require("../config/billpayConfig.json");

// Change name as necessary for different environments
const participants = config["participants"];
const billpayName = web3.utils.asciiToHex(participants["billpay"]);
const checkprintName = web3.utils.asciiToHex(participants["checkprint"]);
const lockboxName = web3.utils.asciiToHex(participants["lockbox"]);

// Change keys as necessary for different environments
const keys = config["keys"];
const billpayPubKey = keys["billpay"]; //Node 2 privateFor key
const checkprintPubKey = keys["checkprint"]; // Node 3 privateFor key
const lockboxPubKey = keys["lockbox"]; //Node 1 privateFor key

// For emitting SendAddress Events
const privateChannelABI = [{"type": "constructor", "inputs": [{"name": "_context", "type": "bytes32", "internalType": "bytes32"}], "payable": false, "stateMutability": "nonpayable"}, {"name": "SendAddress", "type": "event", "inputs": [{"name": "context", "type": "bytes32", "indexed": true, "internalType": "bytes32"}, {"name": "app", "type": "bytes32", "indexed": true, "internalType": "bytes32"}, {"name": "action", "type": "bytes32", "indexed": true, "internalType": "bytes32"}, {"name": "from", "type": "bytes32", "indexed": false, "internalType": "bytes32"}, {"name": "to", "type": "bytes32", "indexed": false, "internalType": "bytes32"}, {"name": "contractAddress", "type": "address", "indexed": false, "internalType": "address"}, {"name": "txnHash", "type": "string", "indexed": false, "internalType": "string"}], "anonymous": false}, {"name": "SendMessage", "type": "event", "inputs": [{"name": "context", "type": "bytes32", "indexed": true, "internalType": "bytes32"}, {"name": "app", "type": "bytes32", "indexed": true, "internalType": "bytes32"}, {"name": "action", "type": "bytes32", "indexed": true, "internalType": "bytes32"}, {"name": "from", "type": "bytes32", "indexed": false, "internalType": "bytes32"}, {"name": "to", "type": "bytes32", "indexed": false, "internalType": "bytes32"}, {"name": "message", "type": "string", "indexed": false, "internalType": "string"}, {"name": "txnHash", "type": "string", "indexed": false, "internalType": "string"}], "anonymous": false}, {"name": "sendAddress", "type": "function", "inputs": [{"name": "_app", "type": "bytes32", "internalType": "bytes32"}, {"name": "_eventType", "type": "bytes32", "internalType": "bytes32"}, {"name": "_from", "type": "bytes32", "internalType": "bytes32"}, {"name": "_to", "type": "bytes32", "internalType": "bytes32"}, {"name": "_address", "type": "address", "internalType": "address"}, {"name": "_txnHash", "type": "string", "internalType": "string"}], "outputs": [{"name": "_success", "type": "bool", "internalType": "bool"}], "payable": false, "constant": false, "stateMutability": "nonpayable"}, {"name": "sendMessage", "type": "function", "inputs": [{"name": "_app", "type": "bytes32", "internalType": "bytes32"}, {"name": "_eventType", "type": "bytes32", "internalType": "bytes32"}, {"name": "_from", "type": "bytes32", "internalType": "bytes32"}, {"name": "_to", "type": "bytes32", "internalType": "bytes32"}, {"name": "_message", "type": "string", "internalType": "string"}, {"name": "_txnHash", "type": "string", "internalType": "string"}], "outputs": [{"name": "_success", "type": "bool", "internalType": "bool"}], "payable": false, "constant": false, "stateMutability": "nonpayable"}];
